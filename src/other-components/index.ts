...
export { default as SimpleCodeEditor, type SimpleCodeEditorProps } from './SimpleCodeEditor';
export { default as VideoViewer, type VideoViewerProps } from './VideoViewer';
